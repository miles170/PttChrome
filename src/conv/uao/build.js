...
child_process.execFileSync("tar", [
  ...
  __dirname,
  "-xjf",
  __dirname + "/big5data.tar.bz2",
]);
build(
  readTable(__dirname + "/uao250-b2u.big5.txt"),
  __dirname + "/../b2u_table.bin",
);
build(
  readTable(__dirname + "/uao250-u2b.big5.txt", true),
  __dirname + "/../u2b_table.bin",
);
